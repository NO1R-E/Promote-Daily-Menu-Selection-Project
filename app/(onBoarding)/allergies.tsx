...
export default function AllergiesScreen() {
  ...
  // 1. โหลดข้อมูล Allergies เดิมของผู้ใช้นี้มาแสดง (ถ้ามี)
  useEffect(() => {
    const fetchExistingAllergies = async () => {
      try {
        ...
        // Query ดึง allergies พร้อม join เอา tag_name จากตาราง tags
        ...
        console.error("Error loading existing allergies:", err);
      }
    };
  ...
  // 2. ค้นหา tag_name จาก Supabase เมื่อ searchQuery เปลี่ยนแปลง
  useEffect(() => {
  ...
  // 3. บันทึกข้อมูลลงตาราง allergies แล้วค่อยเปลี่ยนหน้า
  const handleNext = async () => {
    ...
    try {
      ...
      // ลบข้อมูลเดิมในตาราง user_allergies ของ user คนนี้ออกก่อน (กรณีกลับมาแก้ไข/เลือกใหม่)
      ...
      // ถ้ามีการเลือก Tags ให้ Insert ชุดใหม่ลงไป
      ...
      // ไปยังหน้าถัดไปเมื่อบันทึกสำเร็จ
  ...
  return (
    <View style={styles.container}>
      ...
      {/* ปุ่มกด Next พร้อม Indicator ตอนบันทึก */}
